...
<h1 class="titulo"><b>Restablecer Contraseña<b></h1>
<h5 class="titulo">Ingresa tu nueva Contraseña </h5>
 <div class="contenedor">
   <form  id="form" method="post">
    <div class="mb-3">
        <input type="text" class="form-control" name="pass"  aria-describedby="helpId" placeholder="contraseña"  >
      </div>
